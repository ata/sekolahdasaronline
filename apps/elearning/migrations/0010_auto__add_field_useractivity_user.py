...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserActivity.user'
        db.add_column('elearning_useractivity', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserActivity.user'
        db.delete_column('elearning_useractivity', 'user_id')
