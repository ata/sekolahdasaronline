...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MataPelajaran.tingkat_kelas'
        db.alter_column('elearning_matapelajaran', 'tingkat_kelas_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elearning.TingkatKelas'], null=True, blank=True))

        # Changing field 'MataPelajaran.sekolah'
        db.alter_column('elearning_matapelajaran', 'sekolah_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elearning.Sekolah'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'MataPelajaran.tingkat_kelas'
        db.alter_column('elearning_matapelajaran', 'tingkat_kelas_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elearning.TingkatKelas'], blank=True))

        # Changing field 'MataPelajaran.sekolah'
        db.alter_column('elearning_matapelajaran', 'sekolah_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elearning.Sekolah'], blank=True))
