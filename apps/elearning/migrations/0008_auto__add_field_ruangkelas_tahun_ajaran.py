...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RuangKelas.tahun_ajaran'
        db.add_column('elearning_ruangkelas', 'tahun_ajaran', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['elearning.TahunAjaran']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'RuangKelas.tahun_ajaran'
        db.delete_column('elearning_ruangkelas', 'tahun_ajaran_id')
    ...
    models = {
        ...
        'elearning.ruangkelas': {
            ...
            'sekolah': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['elearning.Sekolah']"}),
            'tahun_ajaran': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['elearning.TahunAjaran']"})
        },
        'elearning.sekolah': {
