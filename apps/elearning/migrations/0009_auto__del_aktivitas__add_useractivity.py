...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('elearning_aktivitas')
    ...
    def backwards(self, orm):
        ...
        db.create_table('elearning_aktivitas', (
            ('waktu', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('aktivitas', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('elearning', ['Aktivitas'])
